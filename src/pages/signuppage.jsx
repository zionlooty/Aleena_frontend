       ...
       <div className="min-h-screen pt-[100px] flex justify-center px-4 items-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form onSubmit={ handleAddNewUser}>
                ...
                <input type="text" name="lastName"  placeholder="Last name" value={formData.lastName} onChange={handleChange}className="w-full px-4 py-2 mt-1 border rounded-md bg-white text-gray-800 outline-none"/>
                </div> */}
                <div  className="flex flex-col gap-2">
                ...
                <input type="submit" value="Register" className="w-40 rounded-md border border-slate-300 bg-black text-white p-2 hover:bg-blue-500"/>
