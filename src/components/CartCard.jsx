    ...
    return (
        ...
        <div className='flex items-center gap-5 shadow rounded-md p-5'>
            ...
            <div className="">
                ...
                <div className='mb-3'>
                    <button className='px-2 text-2xl text-white bg-gray-400 rounded'>-</button>
                    <input type="number"  className='w-12 text-center rounded border-none'/>
                    <button className='px-2 text-2xl text-white bg-orange-400 rounded'>+</button>
                </div>
